...
//	points2.add(100, 180);
	...
	for (int i = 0; i < currentVertices.size(); i++) {
	    QGraphicsEllipseItem vertexPoint = new QGraphicsEllipseItem(currentVertices.get(i).getX() - 2.5, currentVertices.get(i).getY() - 2.5, 5, 5, null,
		    sweepLine);
	...
	QGraphicsLineItem diagonal = new QGraphicsLineItem(newDiagonal.getStartVertex().getX(), newDiagonal.getStartVertex().getY(), newDiagonal.getEndVertex()
		.getX(), newDiagonal.getEndVertex().getY(), null, sweepLine);
	...
	leftMarkedEdge.setLine(toInsert.getStartVertex().getX(), toInsert.getStartVertex().getY(), toInsert.getEndVertex().getX(), toInsert.getEndVertex()
		.getY());
